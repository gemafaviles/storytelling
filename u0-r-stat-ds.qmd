...
::: {layout-ncol="3"}
![**Ingredientes**](img/receta.png){width="15%"}

![**Libro de recetas**](img/libro-receta.png){width="15%"}


![**Tarta**](img/tarta.png){width="15%"}
:::
...
+ **Sesión I. Fundamentos básicos de R**
    ...
    1. *Toolkit* del curso: R, RStduio y Quarto.
    ...
    7. Consideracioines finales. Ejemplos mal aquí o al principio.
